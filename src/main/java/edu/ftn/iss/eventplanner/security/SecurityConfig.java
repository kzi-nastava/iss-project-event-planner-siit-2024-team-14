    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/providers/**", "/api/users/**", "/api/organizers/**",
                        ...
                        "/api/reports/**", "/photos/**", "/event-photo/**", "/api/chat", "/api/chat/*", "/api/chat/**", "/api/chat/***", "/api/chat/blocked-users/", "api/event-types/**", "/api/categories/**", "/api/events/*/products", "/api/events/*/purchases/**", "/api/events/**/**/**", "/api/invitations", "/api/invitations/bulk", "/api/invitations/*", "/api/invitations/**").permitAll()
