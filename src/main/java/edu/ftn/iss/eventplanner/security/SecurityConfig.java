    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/providers/get/","/api/providers/deactivate/", "/api/providers/register", "/api/providers/activate", "/api/providers/update", "/api/providers/get-photos/", "/api/providers/update-photo/",
                        ...
                        "/api/organizers/register", "/api/organizers/update-photo/", "/api/organizers/update", "/api/organizers/get/", "/api/organizers/deactivate/", "/api/organizers/activate", "/api/organizers/get-photo/",
                        ...
                        "/api/invitations", "/api/invitations/bulk","/api/invitations/register",
