    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/providers/**", "/api/users/**", "/api/organizers/**",
                        ...
                        "/api/reports/**", "/photos/**", "/api/chat", "/api/chat/*", "/api/chat/**", "/api/chat/***", "/api/chat/blocked-users/", "/api/categories/**", "/api/events/*/products", "/api/events/*/purchases/**", "/api/events/**/**/**").permitAll()
