    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/providers/get/","/api/providers/deactivate/", "/api/providers/register", "/api/providers/activate", "/api/providers/update", "/api/providers/get-photos/", "/api/providers/update-photo/", "/api/providers/upgrade-to-provider",
                        ...
                        "/api/events/*/products", "/api/events/filter", "/api/events/categories", "/api/events/top5", "/api/events/create-event", "/api/events/all", "/api/events/by-organizer/", "/api/events/locations", "/api/events/*/budget", "/api/events/*/purchases", "/api/events/*/purchases/", "/api/events/*/budget/", "api/events/by-organizer/{organizerId}", "api/events/joined/*",
